# Require TF version to be same as or greater than 1.3.4
terraform {
...
# Download any stable version in AWS provider of 4.38.0 or higher in 4.38 train
provider "aws" {
  region  = "us-east-1"
  version = "~> 4.38.0"
  ...
  assume_role {
    ...
    role_arn     = "arn:aws:iam::184266941689:role/TerraformAssumedIamRole"
